		...
		<div class="row">
			...
			<div class="col-lg-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<select name="tipo_documento" class="form-control">
						<option value="{{$fornecedor->documento_fornecedor}}">{{$fornecedor->documento_fornecedor}}</option>
			...
			<div class="col-lg-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<input type="text" name="numero_documento" required value="{{$fornecedor->numero_documento_fornecedor}}" class="form-control" placeholder="Número do Documento...">
				</div>
			</div>
